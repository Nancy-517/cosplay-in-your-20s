...
- **Endpoint**：`POST https://app-brjk6jdk4ykh-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-brjk6jdk4ykh-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
