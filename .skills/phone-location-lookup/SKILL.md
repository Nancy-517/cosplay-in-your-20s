...
- **Endpoint**：`POST https://app-brjk6jdk4ykh-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
async function queryMobileLocation(
  ...
  const url = new URL("https://app-brjk6jdk4ykh-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-brjk6jdk4ykh-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
